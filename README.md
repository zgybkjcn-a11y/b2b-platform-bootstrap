...
```bash
curl -fsSL https://raw.githubusercontent.com/zgybkjcn-a11y/b2b-platform-bootstrap/main/update.sh | sudo bash
```

已安装最新管理脚本的服务器也可执行 `sudo b2b-platform update`；指定版本使用 `sudo b2b-platform update vX.Y.Z`。
